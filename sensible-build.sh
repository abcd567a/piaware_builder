...
shallow_clone https://github.com/flightaware/piaware.git v10.0.1 $OUTDIR/piaware

shallow_clone https://github.com/flightaware/tcllauncher.git v1.10 $OUTDIR/tcllauncher

shallow_clone https://github.com/flightaware/dump1090.git v10.0.1 $OUTDIR/dump1090

shallow_clone https://github.com/mutability/mlat-client.git v0.2.13 $OUTDIR/mlat-client

shallow_clone https://github.com/flightaware/dump978.git v10.0.1 $OUTDIR/dump978
